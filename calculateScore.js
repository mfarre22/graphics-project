    ...
    // frame 3
      ...
      if(document.getElementById("frame2throw1").innerHTML == 'X') {
          if(document.getElementById("frame1throw1").innerHTML == 'X') {
            ...
            document.getElementById("frame3score").innerHTML = (2*(Number(document.getElementById("frame3throw1").innerHTML) + Number(document.getElementById("frame3throw2").innerHTML))) + 10 + Number(document.getElementById("frame1score").innerHTML);
          }
      }
      else {
